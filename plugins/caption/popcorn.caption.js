...
(function( Popcorn ) {
  ...
  Popcorn.plugin( "caption", function() {

    var createDefaultContainer = function( context ) {
    ...
    return {
      ...
      _setup: function( options ) {
        ...
        var containerId = document.getElementById( options.container.id );
        if ( containerId ) {
          containerId.appendChild( newdiv );
        }
        options.innerContainer = newdiv;

        options.showCaption = function() {
      ...
      start: function( event, options ){
        if ( options.innerContainer ) {
          ...
          options.showCaption( options, options.text );
        }
      },
      /**
       * @member caption
      ...
      _teardown: function ( options ) {
        if ( options.container && options.innerContainer ) {
