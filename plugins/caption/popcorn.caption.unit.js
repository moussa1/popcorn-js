test("Popcorn Caption Plugin", function () {
  ...
  popped.exec( 1, function() {
    popped.media.pause();
    equals( captiondiv.children[ 0 ].innerHTML, "instance 1 video 1 test", "caption displaying correct information" );
    plus();
  ...
  popped2.exec( 8, function() {
    ...
    //let's test to see if the color for caption 4 is blue
    ok( document.getElementById( "caption-3" ).style.color === "blue", "color for caption 4 is correct (blue)" );
    plus();

    ok( caption2div.children[ 0 ].innerHTML === "instance 1 video 2 test", "instance 1 for video 2 is correct at 8 seconds" );
    plus();

    ok( caption2div.children[ 1 ].innerHTML === "instance 2 video 2 test", "instance 2 for video 2 is correct at 8 seconds" );
    plus();
